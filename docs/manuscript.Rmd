...
include_graphics(here("figs/main/M1_sankey.tiff"))
```
...
Current practices of provisioning PEP reactively to Category I exposures. Based on data from the Moramanga District, vial demand could be up to 20% lower if these practices were stopped [@rajeevHealthcareUtilizationProvisioning2018].

Ultimately, it will be challenging to incorporate the complex interactions between socioeconomic factors, access to care, and human behavior. We detail case studies in Box 1 that highlight some of the challenges in capturing variable healthcare seeking behavior, particularly in the context of PEP provisioning, and the policy implications of these exceptions.

## Box 1: case studies of exceptions to the travel time effects

### Anosibe A'nala
In the district of Anosibe A'nala (population of ~ xx people) south of the Moramanga District, travel times to the nearest ARMC (the Moramanga ARMC) are high and highly variable, often exceeding 24 hours.  Despite this, we see a high incidence of reported exposures. We interviewed xx% of these patients when they reported to the clinic, and about xx% {inline} of persons interviewed were loosely defined Category I exposures, members who were close to our touched a person that died from suspected cases. An xx% of them were suspected cases. And no cases were confirmed. The case of AAA points to three key issues: 1) High burden of rabies in this district, we're probably seeing the tip of the iceberg. 2) people when aware of the risk do travel (in many cases walking 3 days to attend the clinic) and when surveillance efforts target cat I around deaths too. Potential for awareness and outreach to go far. 3) This is also where our travel time estimates fail us. Because while there is a road, road speeds are often < 10km per hour and people hitch rides with transport trucks. This is also highly seasonal, during the rainy season it's almost impossible to travel other than by foot. And most people use multiple modes of transport depending on cost and availability (i.e. boat, on foot, by camion).

### Antananarivo (too identifiable?)
A middle aged taxi driver died of rabies in suburban Antananarivo. Bitten by an unknown dog. Promptly reported to a clinic where he was reffered to IPM. His daughter, a prospective medical student, and other family members urged him to seek the vaccine but he did not in the end seek care. He developed symptoms 2 weeks later and died within a few days. The case was confirmed by the NRL. This case points to the other side of the health-seeking behavior coin from AAA. This man had the resources, was aware of the risk, and was reffered by the hospital (and sought care immediately). But ultimately, it's difficult to predict human behavior.
...
<!-- TO DO: WHAT'S THE PT I'M TRYING TO MAKE HERE? -->
...
include_graphics(here("figs/supplementary/S5.1.jpeg"))
```
...
include_graphics(here("figs/supplementary/S5.2.tiff"))
```
...
include_graphics(here("figs/supplementary/S5.3.jpeg"))
```
...
include_graphics(here("figs/supplementary/S5.4.jpeg"))
```
...
include_graphics(here("figs/supplementary/S5.5.jpeg"))
```
...
include_graphics(here("figs/supplementary/S5.6.jpeg"))
```
...
include_graphics(here("figs/supplementary/S5.7.jpeg"))
```
...
include_graphics(here("figs/supplementary/S6.1.jpeg"))
```
...
include_graphics(here("figs/supplementary/S6.2.jpeg"))
```
...
include_graphics(here("figs/supplementary/S6.3.jpeg"))
```
