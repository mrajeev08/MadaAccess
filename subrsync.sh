...
rsync -rLvzt --update --exclude '*.git' --exclude '.gitignore' --exclude "data-raw/raw*" --exclude "*.DS_Store*" --exclude ".Rproj*" --exclude analysis/out --exclude analysis/paper --exclude figs --exclude docs ~/Documents/Projects/MadaAccess mrajeev@della.princeton.edu:~/
