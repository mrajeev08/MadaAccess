...
# Match distcodes by district_id and catchment (row ids in corresponding shapefile and ctar metadata)
district_df[, c('distcode', 'catchment', 'id_ctar') := .(mada_districts$distcode[district_id],
                                              ctar_metadata$CTAR[catchment], 
                                              ctar_metadata$id_ctar[catchment])]
