...
rsync -rLvzt --update --exclude "*.DS_Store*" mrajeev@della.princeton.edu:/scratch/gpfs/mrajeev/MadaAccess/analysis/out ~/Documents/Projects/MadaAccess/zenodo/analysis/
