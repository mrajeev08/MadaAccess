...
### *Fig E. Estimates of mean travel times weighted by population at the (A) District (B) Commune scale.* 
...
include_graphics(here("analysis/figs/supplementary/S4_1_exprange.jpeg"))
```
...
include_graphics(here("analysis/figs/supplementary/S4_2_scaling_rels.jpeg"))
```
...
### Additional supplementary references {#srefextra}
::: {#refs_supextra}
:::
